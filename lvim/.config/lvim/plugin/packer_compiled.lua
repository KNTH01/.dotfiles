...
_G.packer_plugins = {
  ...
  ["vim-surround"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/knth/.local/share/lunarvim/site/pack/packer/opt/vim-surround"
  },
  ["which-key.nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'numb.nvim', 'gitsigns.nvim', 'nvim-spectre', 'nvim-comment'}, { event = "BufRead *" }, _G.packer_plugins)]]
